...
class ForexHistoryTests(unittest.TestCase):
    ...
    def test_valid_history_is_read_only_and_provenanced(self):
        report = load_forex_history(self._file(CSV), symbol="EURUSD", timeframe="M15", source="local_csv")
    ...
    def test_invalid_schema_fails_closed(self):
        report = load_forex_history(self._file("timestamp,close\n2026-07-01T00:00:00+00:00,1.1\n"), symbol="EURUSD", timeframe="M15", source="local_csv")
    ...
    def test_duplicate_timestamp_fails_closed(self):
        report = load_forex_history(self._file(CSV + "2026-07-01T00:15:00+00:00,1.2,1.3,1.1,1.25,12,0.0001\n"), symbol="EURUSD", timeframe="M15", source="local_csv")
