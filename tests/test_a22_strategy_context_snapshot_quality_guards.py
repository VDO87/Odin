...
class A22StrategyContextSnapshotQualityGuardTests(unittest.TestCase):
    ...
    def test_quality_gate_does_not_unlock_runtime(self):
...
def _runtime_text() -> str:
    paths = (
        Path("src/odin/contracts/strategy_context_snapshot_quality.py"),
        Path("src/odin/decision/strategy_context_snapshot_quality.py"),
    )
