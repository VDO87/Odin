---
name: executar_safe_stop
description: Skill operacional Hermes para executar safe stop.
version: 1.0.0
---
...
Executar executar safe stop em modo seguro, mantendo `REAL_TRADING=false` e `SAFE_TO_TRADE=false`.
