...
description: Skill operacional Hermes para recuperar memoria.
version: 1.0.0
---
...
Executar recuperar memoria em modo seguro, mantendo `REAL_TRADING=false` e `SAFE_TO_TRADE=false`.
