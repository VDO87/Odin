---
name: compactar_contexto
description: Skill operacional Hermes para compactar contexto.
version: 1.0.0
---
...
Executar compactar contexto em modo seguro, mantendo `REAL_TRADING=false` e `SAFE_TO_TRADE=false`.
