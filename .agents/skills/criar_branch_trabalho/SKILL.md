---
name: criar_branch_trabalho
description: Skill operacional Hermes para criar branch trabalho.
version: 1.0.0
---
...
Executar criar branch trabalho em modo seguro, mantendo `REAL_TRADING=false` e `SAFE_TO_TRADE=false`.
