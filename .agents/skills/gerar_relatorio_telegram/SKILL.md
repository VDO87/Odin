---
name: gerar_relatorio_telegram
description: Skill operacional Hermes para gerar relatorio telegram.
version: 1.0.0
---
...
Executar gerar relatorio telegram em modo seguro, mantendo `REAL_TRADING=false` e `SAFE_TO_TRADE=false`.
