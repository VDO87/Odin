---
name: validar_resultado_codex
description: Skill operacional Hermes para validar resultado codex.
version: 1.0.0
---
...
Executar validar resultado codex em modo seguro, mantendo `REAL_TRADING=false` e `SAFE_TO_TRADE=false`.
