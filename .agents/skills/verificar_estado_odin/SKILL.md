---
name: verificar_estado_odin
description: Skill operacional Hermes para verificar estado odin.
version: 1.0.0
---
...
Executar verificar estado odin em modo seguro, mantendo `REAL_TRADING=false` e `SAFE_TO_TRADE=false`.
