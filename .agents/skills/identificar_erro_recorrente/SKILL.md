---
name: identificar_erro_recorrente
description: Skill operacional Hermes para identificar erro recorrente.
version: 1.0.0
---
...
Executar identificar erro recorrente em modo seguro, mantendo `REAL_TRADING=false` e `SAFE_TO_TRADE=false`.
