---
name: reiniciar_servico_odin
description: Skill operacional Hermes para reiniciar servico odin.
version: 1.0.0
---
...
Executar reiniciar servico odin em modo seguro, mantendo `REAL_TRADING=false` e `SAFE_TO_TRADE=false`.
