---
name: monitorizar_recursos
description: Skill operacional Hermes para monitorizar recursos.
version: 1.0.0
---
...
Executar monitorizar recursos em modo seguro, mantendo `REAL_TRADING=false` e `SAFE_TO_TRADE=false`.
