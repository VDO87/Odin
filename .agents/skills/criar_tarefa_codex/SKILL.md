---
name: criar_tarefa_codex
description: Skill operacional Hermes para criar tarefa codex.
version: 1.0.0
---
...
Executar criar tarefa codex em modo seguro, mantendo `REAL_TRADING=false` e `SAFE_TO_TRADE=false`.
