---
name: verificar_ollama
description: Skill operacional Hermes para verificar ollama.
version: 1.0.0
---
...
Executar verificar ollama em modo seguro, mantendo `REAL_TRADING=false` e `SAFE_TO_TRADE=false`.
