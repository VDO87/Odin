---
name: recuperar_checkpoint
description: Skill operacional Hermes para recuperar checkpoint.
version: 1.0.0
---
...
Executar recuperar checkpoint em modo seguro, mantendo `REAL_TRADING=false` e `SAFE_TO_TRADE=false`.
