---
name: analisar_logs_recentes
description: Skill operacional Hermes para analisar logs recentes.
version: 1.0.0
---
...
Executar analisar logs recentes em modo seguro, mantendo `REAL_TRADING=false` e `SAFE_TO_TRADE=false`.
