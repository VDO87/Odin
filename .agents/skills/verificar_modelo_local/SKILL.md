---
name: verificar_modelo_local
description: Skill operacional Hermes para verificar modelo local.
version: 1.0.0
---
...
Executar verificar modelo local em modo seguro, mantendo `REAL_TRADING=false` e `SAFE_TO_TRADE=false`.
