---
name: gerar_relatorio_testes
description: Skill operacional Hermes para gerar relatorio testes.
version: 1.0.0
---
...
Executar gerar relatorio testes em modo seguro, mantendo `REAL_TRADING=false` e `SAFE_TO_TRADE=false`.
