---
name: verificar_git_status
description: Skill operacional Hermes para verificar git status.
version: 1.0.0
---
...
Executar verificar git status em modo seguro, mantendo `REAL_TRADING=false` e `SAFE_TO_TRADE=false`.
